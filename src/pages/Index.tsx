...
export default function Index() {
  ...
  const plans = [
    ...
    },
    {
      ...
      hot: false,
      color: "#a855f7",
      features: ["মিডিয়াম স্মার্টের সব ফিচার","আনলিমিটেড টেবিল ও স্টাফ","AI অ্যানালিটিক্স","AI রেকমেন্ডেশন (Gemini)","প্রেডিক্টিভ অ্যানালিটিক্স","কাস্টম ব্র্যান্ডিং (লোগো + রং)","প্রায়োরিটি সাপোর্ট ২৪/৭"],
    },
  ];
